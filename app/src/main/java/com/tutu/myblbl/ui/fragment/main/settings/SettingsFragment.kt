...
class SettingsFragment : BaseFragment<FragmentSettingsBinding>() {
    ...
    private fun setupRecyclerView() {
        ...
        if (binding.recyclerViewSetting.itemDecorationCount == 0) {
    ...
    private fun showChoiceDialog(
        ...
        val choiceAdapter = SettingChoiceAdapter(
    ...
    private class SettingChoiceAdapter(
        private val options: List<String>,
        currentValue: String,
        private val onItemSelected: (String) -> Unit
    ) : RecyclerView.Adapter<SettingChoiceAdapter.SettingChoiceViewHolder>() {

        private var selectedIndex = options.indexOf(currentValue).coerceAtLeast(0)
        ...
        inner class SettingChoiceViewHolder(
            ...
            fun bind(option: String, isSelected: Boolean) {
                ...
                binding.tvInfo.setTextColor(ContextCompat.getColor(binding.root.context, R.color.colorAccent))
                ...
                binding.root.animate()
                    ...
                    .translationX(if (isFocused) binding.root.resources.displayMetrics.density * 6f else 0f)
                    .setDuration(120L)
                    .start()
            }
        }
